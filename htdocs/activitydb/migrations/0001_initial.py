    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=255, null=True, verbose_name=b'Code Name', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.CharField(help_text=b'Please refer to Form 05 - Project Progress Summary', max_length=255, null=True, verbose_name=b'Project Type', blank=True)),
                ...
                ('project_type_other', models.CharField(max_length=255, null=True, verbose_name=b'Select Type', blank=True)),
                ...
                ('capacity', models.ForeignKey(related_name='quant_out_agree', blank=True, to='activitydb.Capacity', null=True)),
                ...
                ('evaluate', models.ForeignKey(related_name='quant_out_agree', blank=True, to='activitydb.Evaluate', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('non_logframe_indicator', models.CharField(max_length=255, null=True, verbose_name=b'Logframe Indicator', blank=True)),
                ('create_date', models.DateTimeField(null=True, blank=True)),
                ('edit_date', models.DateTimeField(null=True, blank=True)),
                ('logframe_indicator', models.ForeignKey(blank=True, to='indicators.Indicator', null=True)),
                ('project_agreement', models.ForeignKey(related_name='q_agreement', blank=True, to='activitydb.ProjectAgreement', null=True)),
                ('project_complete', models.ForeignKey(related_name='q_complete', blank=True, to='activitydb.ProjectAgreement', null=True)),
            ],
            options={
                'ordering': ('description',),
