    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_name', models.CharField(help_text=b'Please be specific in your name.  Consider that your Project Name includes WHO, WHAT, WHERE, HOW', max_length=255, null=True, verbose_name=b'Activity Name', blank=True)),
