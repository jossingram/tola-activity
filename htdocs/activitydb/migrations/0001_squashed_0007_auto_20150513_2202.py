...
class Migration(migrations.Migration):
    ...
    replaces = [(b'activitydb', '0001_initial'), (b'activitydb', '0002_auto_20150512_0042'), (b'activitydb', '0003_auto_20150512_0425'), (b'activitydb', '0004_auto_20150512_0458'), (b'activitydb', '0005_auto_20150512_0509'), (b'activitydb', '0006_auto_20150512_0602'), (b'activitydb', '0007_auto_20150513_2202')]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('percent_complete', models.IntegerField(max_length=25, null=True, verbose_name=b'% complete', blank=True)),
                ('percent_cumulative', models.IntegerField(max_length=25, null=True, verbose_name=b'% cumulative completion', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(help_text=b'See AIMS Village (Shura) Code', max_length=255, null=True, verbose_name=b'Community Profile Code', blank=True)),
                ('type', models.CharField(max_length=255, null=True, verbose_name=b'Profile Type', blank=True)),
                ('existing_village', models.BooleanField(default=b'True', verbose_name=b'Is There an existing shura or CDC?')),
                ...
                ('num_members', models.CharField(max_length=255, null=True, verbose_name=b'Number of Memebers', blank=True)),
                ...
                ('avg_household_size', models.IntegerField(help_text=b'', null=True, verbose_name=b'Average Household Size', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequency', models.IntegerField(max_length=25, null=True, verbose_name=b'Frequency', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_design', models.CharField(max_length=255, null=True, verbose_name=b'Project design for', blank=True)),
                ...
                ('community', models.ManyToManyField(to=b'activitydb.Community', null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_request', models.DateTimeField(null=True, verbose_name=b'Date of Request', blank=True)),
                ('project_name', models.CharField(help_text=b'Please be specific in your name.  Consider that your Project Name includes WHO, WHAT, WHERE, HOW', max_length=255, verbose_name=b'Project Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indicator', models.ForeignKey(blank=True, to='indicators.Indicator', null=True)),
            ],
            options={
                'ordering': ('description',),
