...
class ProjectAgreement(models.Model):
    ...
    total_estimated_budget = models.CharField("Total Project Budget", help_text="In USD", max_length=255, blank=True, null=True)
    mc_estimated_budget = models.CharField("Organizations portion of Project Budget", help_text="In USD", max_length=255, blank=True, null=True)
...
class ProjectComplete(models.Model):
    ...
    account_code = models.CharField("Account Code", help_text='', max_length=255, blank=True, null=True)
    lin_code = models.CharField("LIN Sub Code", help_text='', max_length=255, blank=True, null=True)
    estimated_budget = models.CharField("Estimated Budget", help_text="", max_length=255, null=True, blank=True)
    ...
    total_cost = models.CharField("Estimated Budget for Organization",help_text="In USD", max_length=255, blank=True, null=True)
    agency_cost = models.CharField("Actual Cost for Organization",help_text="In USD", max_length=255, blank=True, null=True)
    local_total_cost = models.CharField("Actual Cost", help_text="In Local Currency", max_length=255, blank=True, null=True)
    local_agency_cost = models.CharField("Actual Cost for Organization", help_text="In Local Currency", max_length=255, blank=True, null=True)
    exchange_rate = models.CharField(help_text="Local Currency exchange rate to USD", max_length=255, blank=True, null=True)
    exchange_rate_date = models.DateField(help_text="Date of exchange rate", blank=True, null=True)
    beneficiary_type = models.CharField("Type of direct beneficiaries", help_text="i.e. Farmer, Association, Student, Govt, etc.", max_length=255, blank=True, null=True)
    average_household_size = models.CharField("Average Household Size", help_text="Refer to Form 01 - Community Profile",max_length=255, blank=True, null=True)
